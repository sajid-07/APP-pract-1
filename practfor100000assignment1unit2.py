...
# Increase integer-to-string digit conversion limit (F(100000) has 20,899 digits)
sys.set_int_max_str_digits(50000)
# Increase recursion depth for fast doubling recursion stack
...
if __name__ == "__main__":
    ...
    # Naive recursion and memoized recursion are skipped for n=100000 to prevent stack overflow.
